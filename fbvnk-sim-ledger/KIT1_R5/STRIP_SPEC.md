...
## The accrual clock — open, and the strip is only half of it
...
**Open, for the board through the PM.** Whichever way Claus answers, both halves take the same
answer. Nothing in this file or in the book was changed to pre-empt it.
