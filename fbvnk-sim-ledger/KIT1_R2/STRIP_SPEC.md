...
This file recommends the accumulator and does not choose: a rate change between two services is
the normal case, not an edge one, because R is a slider Claus moves. Records/Builder decide.
